...
@Component({
  ...
  '../mobile-online-check-details/mobile-online-check-details.component.scss',
 
]
// 
})
export class MobileOnlineCheckWaitingComponent extends OnlineCheckDetailsComponent implements OnInit {

...
@Component({
  selector: "app-desktop-guest-arrived-left",
  templateUrl: "./desktop-guest-arrived-left.component.html",
  styleUrls: ["./desktop-guest-arrived-left.component.scss"],
})
export class DesktopGuestArrivedLeftComponent extends GuestArrivedLeftComponent {
  urlLang: string;
